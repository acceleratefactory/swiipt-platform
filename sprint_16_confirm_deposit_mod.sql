-- ============================================================
-- Sprint 16 — confirm_deposit RPC modification
-- Adds two blocks after goal balance update:
--   1. Trade show member funding check
--   2. Readiness score recalculation
-- Original function body preserved identically; only additions.
-- ============================================================
