    ...
    >
      ...
      {activeTab === "flights" && (
        <div>
          ...
          {/* FROM / TO */}
          <div
            className="flex flex-col gap-2 sm:!grid sm:!grid-cols-[1fr_auto_1fr] sm:items-center sm:gap-2"
          ...
          <div
            className="flex flex-col gap-2 md:!grid md:!grid-cols-3 md:gap-2"
            ...
            >
              ...
              <div style={{ position: "relative", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                ...
                <button
                  ...
                  onClick={(e) => {
                    const input = (e.currentTarget.closest(".date-field") as HTMLElement)?.querySelector(".date-input") as HTMLInputElement;
                    input?.showPicker();
                  }}
                >
