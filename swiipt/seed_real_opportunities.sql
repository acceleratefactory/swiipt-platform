...
('job_seeker', 'Software Engineer — Remote First (USD Salary)', 'Automattic (WordPress)', 'USA', 'Remote',
 ...
 '$80,000–$160,000/year USD', CAST('2026-12-31' AS DATE), 'https://automattic.com/work-with-us/',
...
('job_seeker', 'Senior Backend Engineer — Flutterwave', 'Flutterwave', 'Nigeria', 'Lagos',
 ...
 '$60,000–$100,000/year', CAST('2026-09-30' AS DATE), 'https://careers.flutterwave.com/',
...
('healthcare', 'Registered Nurse — Ireland HSE (Visa Sponsored)', 'Health Service Executive Ireland', 'Ireland', 'Dublin',
 ...
 '€36,000–€51,000/year', CAST('2026-12-31' AS DATE), 'https://www.hse.ie/eng/staff/jobs/nursing/',
...
('healthcare', 'Doctor — UK NHS Foundation Trust', 'NHS England', 'UK', 'London',
 ...
 '£40,000–£85,000/year', CAST('2026-12-31' AS DATE), 'https://www.jobs.nhs.uk/',
...
('tech_professional', 'Senior Frontend Engineer — Andela', 'Andela', 'USA', 'Remote',
 ...
 '$4,000–$8,000/month USD', CAST('2026-10-31' AS DATE), 'https://andela.com/join-network',
...
('job_seeker', 'Product Manager — Paystack', 'Paystack (Stripe)', 'Nigeria', 'Lagos',
 ...
 '$40,000–$70,000/year', CAST('2026-11-30' AS DATE), 'https://paystack.com/careers',
...
('job_seeker', 'Data Scientist — Interswitch', 'Interswitch', 'Nigeria', 'Lagos',
 ...
 '₦8,000,000–₦15,000,000/year', CAST('2026-10-31' AS DATE), 'https://www.interswitchgroup.com/careers',
...
('tech_professional', 'DevOps Engineer — Cloudflare', 'Cloudflare', 'USA', 'Austin TX',
 ...
 '$130,000–$180,000/year USD', CAST('2026-12-31' AS DATE), 'https://www.cloudflare.com/careers/',
...
('job_seeker', 'UX Designer — Kuda Bank', 'Kuda Bank', 'Nigeria', 'Lagos',
 ...
 '₦5,000,000–₦10,000,000/year', CAST('2026-11-15' AS DATE), 'https://kuda.com/careers',
...
('freelancer', 'Senior Full Stack Developer — Toptal', 'Toptal', 'USA', 'Remote',
 ...
 '$60–$150+/hour USD', CAST('2026-12-31' AS DATE), 'https://www.toptal.com/apply',
...
('student', 'Chevening Scholarships 2027 — UK Government', 'UK Government (FCDO)', 'UK', 'London',
 ...
 'Full tuition + living allowance + travel costs', CAST('2026-11-02' AS DATE), 'https://www.chevening.org/scholarships/',
...
('student', 'Erasmus Mundus Joint Master Degree 2027', 'European Commission', 'EU', 'Multiple',
 ...
 'Full tuition + €1,400/month living allowance + travel + insurance', CAST('2027-01-15' AS DATE), 'https://erasmus-plus.ec.europa.eu/',
...
('student', 'Fulbright Foreign Student Programme — USA', 'US Department of State', 'USA', 'Multiple',
 ...
 'Full tuition + stipend + airfare + health insurance', CAST('2026-10-31' AS DATE), 'https://foreign.fulbrightonline.org/',
...
('student', 'Gates Cambridge Scholarships 2027', 'Gates Cambridge Trust', 'UK', 'Cambridge',
 ...
 'Full tuition + £20,000/year living + travel + development fund', CAST('2026-12-03' AS DATE), 'https://www.gatesscholarship.org/',
...
('student', 'DAAD Scholarships — Germany', 'DAAD (German Academic Exchange Service)', 'Germany', 'Multiple',
 ...
 '€861–€1,300/month + tuition waiver + travel + insurance', CAST('2026-10-15' AS DATE), 'https://www.daad.de/en/study-and-research-in-germany/scholarships/',
...
('student', 'Mastercard Foundation Scholars Program — Africa', 'Mastercard Foundation', 'Canada', 'Toronto',
 ...
 'Full tuition + living + travel + mentoring + internship', CAST('2026-12-01' AS DATE), 'https://mastercardfdn.org/all/scholars/',
...
('student', 'Acumen Fellowship — East Africa', 'Acumen', 'Kenya', 'Nairobi',
 ...
 '$20,000 stipend + living allowance + leadership training', CAST('2026-09-15' AS DATE), 'https://acumen.org/fellowship/',
...
('job_seeker', 'Obama Foundation Leaders Africa Programme', 'Obama Foundation', 'Kenya', 'Nairobi',
 ...
 'Full programme coverage + travel + accommodation', CAST('2026-10-31' AS DATE), 'https://www.obama.org/programs/leaders-africa/',
...
('student', 'Google Summer of Code 2026', 'Google', 'USA', 'Remote',
 ...
 '$1,500–$3,300 USD stipend', CAST('2026-04-01' AS DATE), 'https://summerofcode.withgoogle.com/',
...
('student', 'Microsoft Explore Internship — Engineering', 'Microsoft', 'USA', 'Redmond',
 ...
 '$8,000–$10,000/month USD + housing', CAST('2026-09-30' AS DATE), 'https://careers.microsoft.com/us/en/universityprograms',
...
('entrepreneur', 'Africa Netpreneur Prize Initiative', 'Jack Ma Foundation', 'Kenya', 'Nairobi',
 ...
 '$10,000–$250,000', CAST('2026-12-31' AS DATE), 'https://africanprizes.jackmafoundation.org/',
...
('entrepreneur', 'Tony Elumelu Foundation Entrepreneurship Programme', 'Tony Elumelu Foundation', 'Nigeria', 'Lagos',
 ...
 '$5,000 seed capital + training + mentoring', CAST('2026-03-31' AS DATE), 'https://tefconnect.com/',
...
('entrepreneur', 'Hult Prize 2027 — Social Enterprise Challenge', 'Hult Prize Foundation', 'USA', 'Boston',
 ...
 '$1,000,000 prize', CAST('2026-12-01' AS DATE), 'https://www.hultprize.org/',
...
('tech_professional', 'MIT Solve Global Challenges — AI', 'MIT Solve', 'USA', 'Cambridge MA',
 ...
 '$10,000–$75,000 in prizes', CAST('2026-07-01' AS DATE), 'https://solve.mit.edu/',
...
('student', 'Samsung Solve for Tomorrow — Global', 'Samsung Electronics', 'South Korea', 'Seoul',
 ...
 '$100,000 in technology prizes', CAST('2026-10-15' AS DATE), 'https://www.samsung.com/solvefortomorrow/',
...
('entrepreneur', 'Web Summit 2026 — Lisbon', 'Web Summit', 'Portugal', 'Lisbon',
 ...
 'From €650 (early bird)', CAST('2026-11-04' AS DATE), 'https://websummit.com/',
...
('entrepreneur', 'TechCrunch Disrupt 2026', 'TechCrunch', 'USA', 'San Francisco',
 ...
 '$1,995 (general admission)', CAST('2026-10-27' AS DATE), 'https://techcrunch.com/disrupt/',
...
('student', 'African Leadership Forum 2026', 'African Leadership Magazine', 'Nigeria', 'Lagos',
 ...
 '$200 (early bird)', CAST('2026-09-15' AS DATE), 'https://www.africanleadershipmagazine.co.uk/',
...
('entrepreneur', 'Africa Tech Summit Nairobi 2026', 'Africa Tech Summit', 'Kenya', 'Nairobi',
 ...
 '$350 (standard)', CAST('2026-06-15' AS DATE), 'https://africatechsummit.com/',
...
('tech_professional', 'Kaggle Machine Learning Competition — AI for Good', 'Kaggle (Google)', 'USA', 'Remote',
 ...
 '$25,000–$100,000 in prizes', CAST('2026-12-31' AS DATE), 'https://www.kaggle.com/competitions',
...
('tech_professional', 'Devpost Global Hackathon — Health Innovation', 'Devpost', 'USA', 'Remote',
 ...
 '$15,000 in prizes + sponsorship packages', CAST('2026-09-01' AS DATE), 'https://devpost.com/hackathons',
...
('entrepreneur', 'Canton Fair Phase 2 — Spring 2027', 'Canton Fair Committee', 'China', 'Guangzhou',
 ...
 'Free to attend (travel and accommodation separate)', CAST('2027-04-15' AS DATE), 'https://www.canton-fair.org.cn/',
...
('entrepreneur', 'GITEX Global 2026 — Dubai', 'KAOUN International', 'UAE', 'Dubai',
 ...
 'From AED 500 (visitor pass)', CAST('2026-10-15' AS DATE), 'https://www.gitex.com/',
...
('entrepreneur', 'Google for Startups Accelerator — Africa', 'Google', 'Kenya', 'Nairobi',
 ...
 '$100K Google Cloud credits + equity-free funding', CAST('2026-09-01' AS DATE), 'https://startup.withgoogle.com/',
...
('entrepreneur', 'Y Combinator — Startup School', 'Y Combinator', 'USA', 'San Francisco',
 ...
 '$500K investment (on standard terms)', CAST('2026-10-01' AS DATE), 'https://www.ycombinator.com/apply/',
...
('entrepreneur', 'Techstars Austin Accelerator', 'Techstars', 'USA', 'Austin TX',
 ...
 '$120K investment + $100K in perks', CAST('2026-09-15' AS DATE), 'https://www.techstars.com/accelerators',
...
('student', 'Anzisha Prize — Young African Entrepreneurs', 'African Leadership Academy', 'South Africa', 'Johannesburg',
 ...
 '$100,000 grand prize + $50,000 runner-up prizes', CAST('2026-07-31' AS DATE), 'https://www.anzishaprize.org/',
...
('entrepreneur', 'Africa Business Heroes Prize — Alibaba', 'Alibaba Group', 'China', 'Hangzhou',
 ...
 '$300,000 grand prize + $100K–$200K runner-up', CAST('2026-06-30' AS DATE), 'https://www.africabusinessheroes.org/',
...
('healthcare', 'WHO Global Health Professionals Programme', 'World Health Organization', 'Switzerland', 'Geneva',
 ...
 'Monthly stipend + travel + accommodation', CAST('2026-11-01' AS DATE), 'https://www.who.int/careers/',
...
('healthcare', 'Medecins Sans Frontieres — Medical Officer', 'MSF (Doctors Without Borders)', 'Switzerland', 'Geneva',
 ...
 '€1,800–€2,800/month + accommodation + travel + insurance', CAST('2026-12-31' AS DATE), 'https://www.msf.org/work-msf',
